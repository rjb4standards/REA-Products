This file named whois_vdr.json, is an example of a NIST SBOM Vulnerability Disclosure Report (SBOM VDR) for a software product that has no reported vulnerabilities.
