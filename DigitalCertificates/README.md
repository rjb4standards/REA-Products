...
Download Verifyscript.txt and save as a powershell script. sagverify.ps1

Execute the script using the LOC parameter to locate and download the X.509 public key certificate file:
