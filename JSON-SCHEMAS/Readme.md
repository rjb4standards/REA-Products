...
2. Create the "addMe.csv" file that add product information into the SAG-PM database then use sag-pm to add the product to the database (this identifies the VRF file URL)
